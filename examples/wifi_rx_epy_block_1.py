...
class blk(gr.sync_block):  # other base classes are basic_block, decim_block, interp_block
    ...
    def __init__(self, host="127.0.0.1", port=5005, node_id=0):
        ...
        gr.sync_block.__init__(
            self,
            name='Forward Drone ID Packet',   # will show up in GRC
            in_sig=None,
            out_sig=None
        )
    ...
    def handle_msg(self, msg):
        ...
        try:
            ...
            if "e8:94:f6:09:ae:bd" in mac_tx:
                ...
                # Format as ISO 8601 style with nanosecond precision
                formatted_time = f"{datetime.fromtimestamp(seconds).isoformat()}.{nanoseconds:09d}"
